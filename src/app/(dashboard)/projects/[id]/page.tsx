...
import { WeldStatusDonut } from '@/components/projects/WeldStatusDonut'
import { WeldProgressChart } from '@/components/projects/WeldProgressChart'
import { TopWeldersTable } from '@/components/projects/TopWeldersTable'
...
// ── Overview Tab ──────────────────────────────────────────────
function OverviewTab({ project, welds, spools, nde, punch, rfis, stps }: {
  project: Record<string, unknown>; welds: Weld[]; spools: Spool[]; nde: NdeRecord[]; punch: PunchItem[]; rfis: RFI[]; stps: Stp[]
}) {
      ...
      <div className="min-h-64">
        {loadingData ? (
          ...
          <>
            {activeTab === 'overview'      && (
              <div className="space-y-6">
                <OverviewTab project={project} welds={d.welds} spools={d.spools} nde={d.nde} punch={d.punch} rfis={d.rfis} stps={d.stps} />
